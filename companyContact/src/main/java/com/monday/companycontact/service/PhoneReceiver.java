...
public class PhoneReceiver extends BroadcastReceiver {
	...
	public PhoneReceiver(Context context) {
		...
		providerController = ProviderController_.getInstance_(context);
	}
	...
	public void onReceive(Context context, Intent intent) {
		...
		if(intent.getAction().equals(Intent.ACTION_NEW_OUTGOING_CALL)){
			...
			Log.d("TEST", "call OUT:" + phoneNumber);  
		}else{
	...
	PhoneStateListener listener=new PhoneStateListener(){
		...
		public void onCallStateChanged(int state, String incomingNumber) {
			...
			case TelephonyManager.CALL_STATE_RINGING:
				...
				// TODO 输出来电号码
				String name = providerController.isPhoneContaind(incomingNumber);
				if(name != null){
//					ComingCallActivity_.intent(context).flags(Intent.FLAG_ACTIVITY_NEW_TASK)
